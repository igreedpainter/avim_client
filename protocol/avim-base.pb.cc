...
void protobuf_AddDesc_avim_2dbase_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "otocol\030\006 \002(\t:\004avim\022\031\n\016encrype_method\030\007 \001"
    "(\r:\0010\022\026\n\016msg_dont_route\030\t \001(\010\0222\n\010need_se"
    "q\030\013 \001(\0132 .proto.base.avPacket.ack_contro"
    "l\022\017\n\007payload\030\010 \001(\014\032\036\n\013ack_control\022\017\n\007ack"
    "_seq\030\001 \002(\004\"\222\002\n\004aGMP\022)\n\007pkreply\030\001 \001(\0132\030.p"
    "roto.base.aGMP.PKREPLY\0224\n\rnoroutetohost\030"
    "\002 \001(\0132\035.proto.base.aGMP.NOROUTTOHOST\022\'\n\006"
    "ttlout\030\003 \001(\0132\027.proto.base.aGMP.TTLOUT\032\034\n"
    "\007PKREPLY\022\021\n\tx509_cert\030\001 \002(\014\0323\n\014NOROUTTOH"
    "OST\022#\n\004host\030\001 \002(\0132\025.proto.base.avAddress"
    "\032-\n\006TTLOUT\022#\n\004host\030\001 \002(\0132\025.proto.base.av"
    "Address\"\213\001\n\013avTCPPacket\022\014\n\004type\030\001 \002(\r\022&\n"
    "\010avpacket\030\002 \001(\0132\024.proto.base.avPacket\022/\n"
    "\020endpoint_address\030\003 \001(\0132\025.proto.base.avA"
    "ddress\022\025\n\rendpoint_cert\030\004 \001(\014", 829);
...
avPacket_ack_control::avPacket_ack_control()
  : ::google::protobuf::Message() {
  SharedCtor();
  // @@protoc_insertion_point(constructor:proto.base.avPacket.ack_control)
}
...
avPacket_ack_control::avPacket_ack_control(const avPacket_ack_control& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:proto.base.avPacket.ack_control)
}
...
avPacket_ack_control::~avPacket_ack_control() {
  // @@protoc_insertion_point(destructor:proto.base.avPacket.ack_control)
  SharedDtor();
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:proto.base.avPacket.ack_control)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(127);
    tag = p.first;
    if (!p.second) goto handle_unusual;
...
success:
  // @@protoc_insertion_point(parse_success:proto.base.avPacket.ack_control)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:proto.base.avPacket.ack_control)
  return false;
#undef DO_
}
...
void avPacket_ack_control::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:proto.base.avPacket.ack_control)
  // required uint64 ack_seq = 1;
  if (has_ack_seq()) {
  ...
  // @@protoc_insertion_point(serialize_end:proto.base.avPacket.ack_control)
}

::google::protobuf::uint8* avPacket_ack_control::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:proto.base.avPacket.ack_control)
  // required uint64 ack_seq = 1;
  if (has_ack_seq()) {
  ...
  // @@protoc_insertion_point(serialize_to_array_end:proto.base.avPacket.ack_control)
  return target;
}
...
void avPacket::InitAsDefaultInstance() {
  ...
  need_seq_ = const_cast< ::proto::base::avPacket_ack_control*>(&::proto::base::avPacket_ack_control::default_instance());
}
...
void avPacket::MergeFrom(const avPacket& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    ...
    if (from.has_need_seq()) {
      mutable_need_seq()->::proto::base::avPacket_ack_control::MergeFrom(from.need_seq());
    }
  }
...
aGMP_PKREPLY::aGMP_PKREPLY()
  : ::google::protobuf::Message() {
  SharedCtor();
  // @@protoc_insertion_point(constructor:proto.base.aGMP.PKREPLY)
}
...
aGMP_PKREPLY::aGMP_PKREPLY(const aGMP_PKREPLY& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:proto.base.aGMP.PKREPLY)
}
...
aGMP_PKREPLY::~aGMP_PKREPLY() {
  // @@protoc_insertion_point(destructor:proto.base.aGMP.PKREPLY)
  SharedDtor();
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:proto.base.aGMP.PKREPLY)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(127);
    tag = p.first;
    if (!p.second) goto handle_unusual;
...
success:
  // @@protoc_insertion_point(parse_success:proto.base.aGMP.PKREPLY)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:proto.base.aGMP.PKREPLY)
  return false;
#undef DO_
}
...
void aGMP_PKREPLY::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:proto.base.aGMP.PKREPLY)
  // required bytes x509_cert = 1;
  if (has_x509_cert()) {
    ::google::protobuf::internal::WireFormatLite::WriteBytesMaybeAliased(
  ...
  // @@protoc_insertion_point(serialize_end:proto.base.aGMP.PKREPLY)
}

::google::protobuf::uint8* aGMP_PKREPLY::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:proto.base.aGMP.PKREPLY)
  // required bytes x509_cert = 1;
  if (has_x509_cert()) {
    target =
      ::google::protobuf::internal::WireFormatLite::WriteBytesToArray(
  ...
  // @@protoc_insertion_point(serialize_to_array_end:proto.base.aGMP.PKREPLY)
  return target;
}
...
aGMP_NOROUTTOHOST::aGMP_NOROUTTOHOST()
  : ::google::protobuf::Message() {
  SharedCtor();
  // @@protoc_insertion_point(constructor:proto.base.aGMP.NOROUTTOHOST)
}

void aGMP_NOROUTTOHOST::InitAsDefaultInstance() {
  host_ = const_cast< ::proto::base::avAddress*>(&::proto::base::avAddress::default_instance());
}
...
aGMP_NOROUTTOHOST::aGMP_NOROUTTOHOST(const aGMP_NOROUTTOHOST& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:proto.base.aGMP.NOROUTTOHOST)
}
...
aGMP_NOROUTTOHOST::~aGMP_NOROUTTOHOST() {
  // @@protoc_insertion_point(destructor:proto.base.aGMP.NOROUTTOHOST)
  SharedDtor();
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:proto.base.aGMP.NOROUTTOHOST)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(127);
    tag = p.first;
    if (!p.second) goto handle_unusual;
...
success:
  // @@protoc_insertion_point(parse_success:proto.base.aGMP.NOROUTTOHOST)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:proto.base.aGMP.NOROUTTOHOST)
  return false;
#undef DO_
}
...
void aGMP_NOROUTTOHOST::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:proto.base.aGMP.NOROUTTOHOST)
  // required .proto.base.avAddress host = 1;
  if (has_host()) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      1, this->host(), output);
  ...
  // @@protoc_insertion_point(serialize_end:proto.base.aGMP.NOROUTTOHOST)
}

::google::protobuf::uint8* aGMP_NOROUTTOHOST::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:proto.base.aGMP.NOROUTTOHOST)
  // required .proto.base.avAddress host = 1;
  if (has_host()) {
    target = ::google::protobuf::internal::WireFormatLite::
      WriteMessageNoVirtualToArray(
  ...
  // @@protoc_insertion_point(serialize_to_array_end:proto.base.aGMP.NOROUTTOHOST)
  return target;
}
...
void aGMP_NOROUTTOHOST::MergeFrom(const aGMP_NOROUTTOHOST& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    if (from.has_host()) {
      mutable_host()->::proto::base::avAddress::MergeFrom(from.host());
    }
  }
  mutable_unknown_fields()->MergeFrom(from.unknown_fields());
}
...
aGMP_TTLOUT::aGMP_TTLOUT()
  : ::google::protobuf::Message() {
  SharedCtor();
  // @@protoc_insertion_point(constructor:proto.base.aGMP.TTLOUT)
}
...
aGMP_TTLOUT::aGMP_TTLOUT(const aGMP_TTLOUT& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:proto.base.aGMP.TTLOUT)
}
...
aGMP_TTLOUT::~aGMP_TTLOUT() {
  // @@protoc_insertion_point(destructor:proto.base.aGMP.TTLOUT)
  SharedDtor();
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:proto.base.aGMP.TTLOUT)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(127);
    tag = p.first;
    if (!p.second) goto handle_unusual;
...
success:
  // @@protoc_insertion_point(parse_success:proto.base.aGMP.TTLOUT)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:proto.base.aGMP.TTLOUT)
  return false;
#undef DO_
}
...
void aGMP_TTLOUT::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:proto.base.aGMP.TTLOUT)
  // required .proto.base.avAddress host = 1;
  if (has_host()) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      1, this->host(), output);
  ...
  // @@protoc_insertion_point(serialize_end:proto.base.aGMP.TTLOUT)
}

::google::protobuf::uint8* aGMP_TTLOUT::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:proto.base.aGMP.TTLOUT)
  // required .proto.base.avAddress host = 1;
  if (has_host()) {
    target = ::google::protobuf::internal::WireFormatLite::
      WriteMessageNoVirtualToArray(
  ...
  // @@protoc_insertion_point(serialize_to_array_end:proto.base.aGMP.TTLOUT)
  return target;
}
...
void aGMP::InitAsDefaultInstance() {
  pkreply_ = const_cast< ::proto::base::aGMP_PKREPLY*>(&::proto::base::aGMP_PKREPLY::default_instance());
  noroutetohost_ = const_cast< ::proto::base::aGMP_NOROUTTOHOST*>(&::proto::base::aGMP_NOROUTTOHOST::default_instance());
  ttlout_ = const_cast< ::proto::base::aGMP_TTLOUT*>(&::proto::base::aGMP_TTLOUT::default_instance());
}
...
void aGMP::MergeFrom(const aGMP& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    if (from.has_pkreply()) {
      mutable_pkreply()->::proto::base::aGMP_PKREPLY::MergeFrom(from.pkreply());
    }
    if (from.has_noroutetohost()) {
      mutable_noroutetohost()->::proto::base::aGMP_NOROUTTOHOST::MergeFrom(from.noroutetohost());
    }
    if (from.has_ttlout()) {
      mutable_ttlout()->::proto::base::aGMP_TTLOUT::MergeFrom(from.ttlout());
    }
  }
  mutable_unknown_fields()->MergeFrom(from.unknown_fields());
}
